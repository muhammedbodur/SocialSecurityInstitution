    ...
    public partial class mig_1 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HubConnection", x => x.HubConnectionId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DatabaseLog_Personeller_PersonellerTcKimlikNo",
                        column: x => x.PersonellerTcKimlikNo,
                        principalTable: "Personeller",
                        principalColumn: "TcKimlikNo");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DatabaseLog_PersonellerTcKimlikNo",
                table: "DatabaseLog",
                column: "PersonellerTcKimlikNo");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_KioskIslemGruplari_HizmetBinasiId_KioskIslemGrupSira",
                table: "KioskIslemGruplari",
                columns: new[] { "HizmetBinasiId", "KioskIslemGrupSira" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_KioskIslemGruplari_KioskGrupId_HizmetBinasiId",
                table: "KioskIslemGruplari",
